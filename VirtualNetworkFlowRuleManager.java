...
public class VirtualNetworkFlowRuleManager
    ...
    @Override
    public String printLog(MacAddress src, MacAddress dst, DeviceId id) {return null;}
    ...
    public int getPacketCount(MacAddress src, MacAddress dst, DeviceId id) {
        try {
            FileWriter output = new FileWriter("/home/sdn/log/replace/1.txt", true);
            String s = "getPacketCount\n";
            output.write(s);
            output.close();
