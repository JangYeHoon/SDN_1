...
public interface FlowRuleService
    ...
    void updateIntervalTIme(MacAddress src, MacAddress dst, DeviceId id, int flag);

    String printLog(MacAddress src, MacAddress dst, DeviceId id);

    long getIntervalTime(MacAddress src, MacAddress dst, DeviceId id, int flag, long ct);

    Long checkLastTime(MacAddress src, MacAddress dst, DeviceId id);

    void setZeroPacketCount(MacAddress src, MacAddress dst, DeviceId id);

    void setPacketCount(MacAddress src, MacAddress dst, DeviceId id);

    int getPacketCount(MacAddress src, MacAddress dst, DeviceId id);

    int getFlowFlag(MacAddress src, MacAddress dst, DeviceId id);

    void setFlowFlag(MacAddress src, MacAddress dst, DeviceId id);
